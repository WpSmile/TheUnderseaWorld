...
import com.qifeng.theunderseaworld.adapter.OrderFinishingBusinessAdapter;
 ...
 */
public class OrderFinishingBusinessFragment extends Fragment {
    ...
    private void initView() {
        ...
        mAdapter = new OrderFinishingBusinessAdapter(mContext, groupList, childList);
