...
import com.qifeng.theunderseaworld.adapter.OrderFinishedCustomerAdapter;
...
public class OrderFinishedFragment extends Fragment {
    ...
    int parent_id;
    OrderFinishedCustomerAdapter mAdapter;
    ...
    private void initView() {
        ...
        mAdapter = new OrderFinishedCustomerAdapter(mContext,groupList,childList);
