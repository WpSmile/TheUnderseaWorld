...
import com.qifeng.theunderseaworld.adapter.OrderTuikuanBuninessAdapter;
 ...
 */
public class OrderTuikuanBusinessFragment extends Fragment {
    ...
    private void initView() {
        ...
        mAdapter = new OrderTuikuanBuninessAdapter(mContext, groupList, childList);
