...
public class OrderFinishingBusinessAdapter extends BaseExpandableListAdapter {
    ...
    public OrderFinishingBusinessAdapter(Context mContext, ArrayList<OrderFinishedGroupBean> grouplist, ArrayList<OrderFinishedChildBean> childlist) {
    ...
    static class ChildViewHolder {
        ...
        ChildViewHolder(View view) {
            ...
            orderManagerBtnDeal.setText("等待交易");
            orderManagerTvApplyRefund.setVisibility(View.GONE);
            orderManagerTvApplyTuihuo.setVisibility(View.GONE);
            orderManagerLlPingjia.setVisibility(View.GONE);
            todayTextDataTime.setVisibility(View.GONE);
        }
    }
