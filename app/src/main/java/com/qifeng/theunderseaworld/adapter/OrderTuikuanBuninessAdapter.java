...
public class OrderTuikuanBuninessAdapter extends BaseExpandableListAdapter {
    ...
    public OrderTuikuanBuninessAdapter(Context mContext, ArrayList<OrderFinishedGroupBean> grouplist, ArrayList<OrderFinishedChildBean> childlist) {
