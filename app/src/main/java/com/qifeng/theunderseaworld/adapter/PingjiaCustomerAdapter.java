...
public class PingjiaCustomerAdapter extends RecyclerView.Adapter {
    Context mContext;
    //用于存放item的集合
    ArrayList<PingjiaCustomerBean> PingjiaCustomerList;
    ...
    public PingjiaCustomerAdapter() {

    }


    public PingjiaCustomerAdapter(Context mContext, ArrayList<PingjiaCustomerBean> todayActivityList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        layout = inflater.inflate(R.layout.item_pingjia_system_customer, parent, false);
