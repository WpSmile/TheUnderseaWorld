...
public class OrderFinishedBunsinessAdapter extends BaseExpandableListAdapter {
    ...
    public OrderFinishedBunsinessAdapter(Context mContext, ArrayList<OrderFinishedGroupBean> grouplist, ArrayList<OrderFinishedChildBean> childlist) {
